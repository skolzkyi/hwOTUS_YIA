...
func TestGetEvent(t *testing.T) {
	...
	respExp := `{"Events":[{"ID":0,"Title":"testData","UserID":"USER0","Description":"","DateStart":"2023-04-20T00:00:00.000000001+04:00","DateStop":"2023-04-20T04:00:00.000000001+04:00","EventMessageTimeDelta":14400000000000}],"Message":{"Text":"OK!","Code":0}}` // nolint:lll
	require.Equal(t, respExp, string(respBody))
}
...
func TestGetEventsOnDayByDay(t *testing.T) {
	...
	respExp := `{"Events":[{"ID":4,"Title":"test4 - start in before week and end in cur week","UserID":"USER0","Description":"","DateStart":"2023-04-18T12:00:00.000000001+04:00","DateStop":"2023-04-20T07:00:00.000000001+04:00","EventMessageTimeDelta":14400000000000},{"ID":5,"Title":"test5 - in this day","UserID":"USER0","Description":"","DateStart":"2023-04-20T08:00:00.000000001+04:00","DateStop":"2023-04-20T09:00:00.000000001+04:00","EventMessageTimeDelta":14400000000000},{"ID":0,"Title":"test0 - base event","UserID":"USER0","Description":"","DateStart":"2023-04-20T12:00:00.000000001+04:00","DateStop":"2023-04-20T16:00:00.000000001+04:00","EventMessageTimeDelta":14400000000000}],"Message":{"Text":"OK!","Code":0}}` // nolint:lll
	require.Equal(t, respExp, string(respBody))
}
...
func TestGetEventsOnWeekByDay(t *testing.T) {
	...
	respExp := `{"Events":[{"ID":4,"Title":"test4 - start in before week and end in cur week","UserID":"USER0","Description":"","DateStart":"2023-04-18T12:00:00.000000001+04:00","DateStop":"2023-04-20T07:00:00.000000001+04:00","EventMessageTimeDelta":14400000000000},{"ID":5,"Title":"test5 - in this day","UserID":"USER0","Description":"","DateStart":"2023-04-20T08:00:00.000000001+04:00","DateStop":"2023-04-20T09:00:00.000000001+04:00","EventMessageTimeDelta":14400000000000},{"ID":0,"Title":"test0 - base event","UserID":"USER0","Description":"","DateStart":"2023-04-20T12:00:00.000000001+04:00","DateStop":"2023-04-20T16:00:00.000000001+04:00","EventMessageTimeDelta":14400000000000},{"ID":1,"Title":"test1 - +5days","UserID":"USER0","Description":"","DateStart":"2023-04-25T12:00:00.000000001+04:00","DateStop":"2023-04-25T16:00:00.000000001+04:00","EventMessageTimeDelta":14400000000000},{"ID":2,"Title":"test2 - +6 days end date after week","UserID":"USER0","Description":"","DateStart":"2023-04-26T12:00:00.000000001+04:00","DateStop":"2023-04-26T18:00:00.000000001+04:00","EventMessageTimeDelta":14400000000000}],"Message":{"Text":"OK!","Code":0}}` // nolint:lll
	require.Equal(t, respExp, string(respBody))
}
...
func TestGetEventsOnMonthByDay(t *testing.T) {
	...
	respExp := `{"Events":[{"ID":4,"Title":"test4 - start in before week and end in cur week","UserID":"USER0","Description":"","DateStart":"2023-04-18T12:00:00.000000001+04:00","DateStop":"2023-04-20T07:00:00.000000001+04:00","EventMessageTimeDelta":14400000000000},{"ID":5,"Title":"test5 - in this day","UserID":"USER0","Description":"","DateStart":"2023-04-20T08:00:00.000000001+04:00","DateStop":"2023-04-20T09:00:00.000000001+04:00","EventMessageTimeDelta":14400000000000},{"ID":0,"Title":"test0 - base event","UserID":"USER0","Description":"","DateStart":"2023-04-20T12:00:00.000000001+04:00","DateStop":"2023-04-20T16:00:00.000000001+04:00","EventMessageTimeDelta":14400000000000},{"ID":1,"Title":"test1 - +5days","UserID":"USER0","Description":"","DateStart":"2023-04-25T12:00:00.000000001+04:00","DateStop":"2023-04-25T16:00:00.000000001+04:00","EventMessageTimeDelta":14400000000000},{"ID":2,"Title":"test2 - +6 days end date after week","UserID":"USER0","Description":"","DateStart":"2023-04-26T12:00:00.000000001+04:00","DateStop":"2023-04-26T18:00:00.000000001+04:00","EventMessageTimeDelta":14400000000000},{"ID":3,"Title":"test3 - +8 days - next week","UserID":"USER0","Description":"","DateStart":"2023-04-28T12:00:00.000000001+04:00","DateStop":"2023-04-28T20:00:00.000000001+04:00","EventMessageTimeDelta":14400000000000}],"Message":{"Text":"OK!","Code":0}}` // nolint:lll
	require.Equal(t, respExp, string(respBody))
}
